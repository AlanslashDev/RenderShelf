    ...
    <div class="studio-container">
        ...
        <div class="revenue-card">
            ...
            <a href="upload.php" class="btn-primary"
                style="width: auto; padding: 14px 25px; display: flex; align-items: center; gap: 10px; text-decoration: none;">
                ...
                <?php foreach ($my_uploads as $asset): ?>
                    <div class="asset-card" style="background: var(--card-bg); border: 1px solid rgba(255,255,255,0.05);">
                        <div class="asset-thumb" style="height: 160px;">
                            ...
                            <div
                                style="position: absolute; top: 12px; right: 12px; padding: 5px 10px; border-radius: 8px; font-size: 10px; font-weight: 800; text-transform: uppercase; background: <?php echo $asset['is_approved'] == 1 ? 'rgba(56, 239, 125, 0.9)' : 'rgba(255, 193, 7, 0.9)'; ?>; color: black; backdrop-filter: blur(5px);">
                                <?php echo $asset['is_approved'] == 1 ? 'Approved' : 'Pending'; ?>
                            </div>
                        </div>
                        <div class="asset-info">
                            ...
                            <div
                                ...
                                <span
                                    style="font-size: 12px; color: #666;"><?php echo htmlspecialchars($asset['category_name']); ?></span>
                                <span
                                    style="font-weight: 700; color: var(--accent-color);">₹<?php echo number_format($asset['price'], 2); ?></span>
                            </div>
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                                <a href="asset_details.php?id=<?php echo $asset['id']; ?>" class="action-btn"
                                    style="background: rgba(255,255,255,0.05); color: white; padding: 8px; font-size: 12px; margin:0; border-radius: 10px; text-decoration: none;">View</a>
                                <a href="edit_asset.php?id=<?php echo $asset['id']; ?>" class="action-btn"
                                    style="background: rgba(255,255,255,0.05); color: white; padding: 8px; font-size: 12px; margin:0; border-radius: 10px; text-decoration: none;">Edit</a>
                                <a href="delete_asset_user.php?id=<?php echo $asset['id']; ?>"
                                    ...
                                    class="action-btn"
                                    style="grid-column: span 2; background: rgba(255, 68, 68, 0.1); color: #ff4444; padding: 8px; font-size: 12px; margin:0; border-radius: 10px; text-decoration: none; border: 1px solid rgba(255, 68, 68, 0.1);">Delete
                                    Asset</a>
                            </div>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <div
                style="text-align: center; padding: 100px 20px; background: rgba(255,255,255,0.02); border-radius: 30px; border: 1px dashed rgba(255,255,255,0.1);">
                <ion-icon name="cloud-upload-outline"
                    style="font-size: 64px; margin-bottom: 20px; color: var(--accent-color); opacity: 0.5;"></ion-icon>
                ...
                <a href="upload.php" class="btn-primary"
                    style="width: auto; display: inline-flex; padding: 14px 40px; border-radius: 15px;">Start Creating</a>
            </div>
        <?php endif; ?>
